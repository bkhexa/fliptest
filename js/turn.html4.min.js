...
(function (f) {
    ...
    function t (a, b, c, d, e) {
      ...
      return m (
        Math.round (
          f * a.x + 3 * e * g * g * b.x + 3 * e * e * g * c.x + l * d.x
        ),
    ...
    var r = '',
      ...
      i = {
        ...
        addPage: function (a, b) {
          ...
          1 <= b &&
            ...
            ((c = 'double' == e.display
              ? b % 2 ? ' odd' : ' even'
              : ''), e.done && this.turn ('stop'), b in e.pageObjs &&
              i._movePages.call (this, b, 1), d &&
              (e.totalPages = g), (e.pageObjs[b] = f (a)
              .css ({float: 'left'})
              .addClass ('page p' + b + c)), i._addPage.call (this, b), e.done &&
              this.turn ('update'), i._removeFromDOM.call (this));
          return this;
        },
        _addPage: function (a) {
        ...
        center: function (a) {
          ...
          'double' == b.display &&
            ((a = this.turn ('view', a || b.tpage || b.page)), 'ltr' ==
              b.direction
        ...
        _pageSize: function (a, b) {
          var c = this.data (), d = {};
          if ('single' == c.display)
            (d.width = this.width ()), (d.height = this.height ()), b &&
              ((d.top = 0), (d.left = 0), (d.right = 'auto'));
          else {
            var e = this.width () / 2, g = this.height ();
            c.pageObjs[a].hasClass ('own-size')
              ? ((d.width = c.pageObjs[a].width ()), (d.height = c.pageObjs[
                  a
                ].height ()))
            ...
            if (b) {
              ...
              d.top = (g - d.height) / 2;
              'ltr' == c.direction
                ? ((d[f ? 'right' : 'left'] = e - d.width), (d[
                    f ? 'left' : 'right'
                  ] =
                    'auto'))
                : ((d[f ? 'left' : 'right'] = e - d.width), (d[
                    f ? 'right' : 'left'
                  ] =
                    'auto'));
            }
        ...
        range: function (a) {
          ...
          1 <= d[0] && d[1] <= e.totalPages
            ? ((a = Math.floor (2)), e.totalPages - d[1] > d[0]
        ...
        removePage: function (a) {
          ...
          b.pageObjs[a] &&
            (this.turn ('stop'), i._removePageFromDOM.call (this, a), delete b
              .pageObjs[a]);
        ...
        _movePages: function (a, b) {
          var c,
            ...
            f = function (a) {
              ...
              e.pagePlace[a] &&
                e.pageWrap[a] &&
                ((e.pagePlace[c] = c), (e.pageWrap[c] = e.pageObjs[c].hasClass (
                  'fixed'
                )
                  ? e.pageWrap[a].attr ('page', c)
                  : e.pageWrap[a]
                      .css (i._pageSize.call (d, c, !0))
                      .attr ('page', c)), e.pages[a] &&
                  ...
                  (delete e.pages[a], delete e.pagePlace[a], delete e.pageObjs[
                    a
                  ], delete e.pageWrap[a], delete e.pageObjs[a]));
            };
        ...
        display: function (a) {
          ...
          if (a) {
            ...
            b.display = a;
            c &&
              ((a = this.turn ('size')), i._movePages.call (
                this,
                1,
                0
        ...
        disable: function (a) {
          ...
          for (b in c.pages)
            j (b, c.pages) &&
              c.pages[b].flip ('disable', a ? f.inArray (b, d) : !1);
          return this;
        },
        disabled: function (a) {
          return void 0 === a
        ...
        size: function (a, b) {
          if (a && b) {
            ...
            for (c in e.pageWrap)
              j (c, e.pageWrap) &&
                ((d = i._pageSize.call (this, c, !0)), e.pageObjs[c].css ({
                  width: d.width,
                  height: d.height,
                }), e.pageWrap[c].css (d), e.pages[c] &&
        ...
        resize: function () {
          var a, b = this.data ();
          b.pages[0] &&
            (b.pageWrap[0].css ({left: -this.width ()}), b.pages[0].flip (
              'resize',
              !0
            ));
        ...
        stop: function () {
          if (this.turn ('animating')) {
            var a, b, c, d = this.data (), e = d.pageMv;
            d.pageMv = [];
            d.tpage && ((d.page = d.tpage), delete d.tpage);
            for (a = 0; a < e.length; a++)
              (c = d.pages[e[a]]), (b = c.data ().f.opts), c.flip (
                'hideFoldedPage',
                !1
              ), h._moveFoldingPage.call (c, !1), (d.pagePlace[b.next] =
                b.next), b.force &&
                ((b.next = 0 === b.page % 2
                  ? b.page - 1
                  : b.page + 1), delete b.force);
          }
          this.turn ('update');
          return this;
        },
        ...
        _fitPage: function (a) {
          ...
          b.pageObjs[a] &&
            ((b.page = a), this.turn ('stop'), i._removeFromDOM.call (
              this
            ), i._makeRange.call (this), i._updateShadow.call (
              this
            ), this.trigger ('turned', [a, c]), b.opts.autoCenter &&
              this.turn ('center'));
        },
        _turnPage: function (a, b) {
          ...
          e.pages[c] &&
            ((g = e.pages[c].data ().f.opts), (e.tpage = d), g.next != d &&
              ((g.next = d), (e.pagePlace[d] =
                g.page), (g.force = !0)), 'single' == e.display
              ? 'ltr' == e.direction
        ...
        _start: function (a, b, c) {
          ...
          a.isDefaultPrevented () ||
            ('single' == d.display &&
              ...
              (('l' == c && 'ltr' == d.direction) ||
                ('r' == c && 'rtl' == d.direction)
                ? ((b.next = b.next < b.page
                    ? b.next
                    : b.page - 1), (b.force = !0))
                : (b.next = b.next > b.page
                    ? b.next
                    : b.page + 1)), i._addMotionPage.call (a.target));
        ...
        _end: function (a, b, c) {
          ...
          if (c || d.tpage) {
            ...
            i._removeMv.call (a, b.page), i._updateShadow.call (a), a.turn (
              'update'
            );
        },
        _pressed: function (a) {
          ...
          for (b in c)
            b != a.opts.page && c[b].flip ('disable', !0);
        ...
        _released: function (a, b) {
          ...
          var c,
            ...
            u = g.data ();
          c = 'single' == u.display
            ? 'r' == b.corner ? b.x < d.width () / 2 : b.x > d.width () / 2
            : 0 > b.x || b.x > d.width ();
          if (200 > new Date ().getTime () - e.time || c)
            a.preventDefault (), i._turnPage.call (
              g,
              e.opts.next,
        ...
        calculateZ: function (a) {
          ...
          for (b = 0; b < a.length; b++)
            (c = a[b]), (d = f.pages[c].data ().f.opts.next), (e =
              f.pagePlace[c]), j (c), j (d), (c = f.pagePlace[d] == d
              ? d
              : c), (i.pageZ[c] = f.totalPages - Math.abs (h - c)), (i.partZ[e] =
              2 * f.totalPages + Math.abs (h - c));
          return i;
        },
        update: function () {
          var a, b = this.data ();
          if (b.pageMv.length && 0 !== b.pageMv[0]) {
            ...
            for (a in b.pageWrap)
              if (
                ...
                c.flip ('z', d.partZ[a] || null), d.pageV[a] &&
                  c.flip ('resize'), b.tpage && c.flip ('disable', !0);
          } else
            for (a in b.pageWrap)
              j (a, b.pageWrap) &&
                ((d = i._setPageLoc.call (this, a)), b.pages[a] &&
                  b.pages[a]
        ...
        _updateShadow: function () {
          ...
          for (var h = 0; h < c.pageMv.length && a[0] && a[1]; h++)
            (a = this.turn (
              'view',
              c.pages[c.pageMv[h]].data ().f.opts.next
            )), (b = this.turn ('view', c.pageMv[h])), (a[0] =
              a[0] && b[0]), (a[1] = a[1] && b[1]);
          switch (a[0]
            ? a[1] ? 3 : 'ltr' == c.direction ? 2 : 1
            : 'ltr' == c.direction ? 1 : 2) {
            case 1:
        ...
        _setPageLoc: function (a) {
          ...
          if (
            ...
            return b.pageWrap[a].css ({zIndex: b.totalPages - 1, display: ''}), 2;
          b.pageWrap[a].css ({
            zIndex: 0,
      ...
      h = {
        ...
        z: function (a) {
          var b = this.data ().f;
          b.fwrapper &&
            ((b.opts['z-index'] = a), b.fwrapper.css ({
        ...
        _cAllowed: function () {
          ...
          return 'single' == b.display
            ? 1 == a
                ? 'ltr' == b.direction ? p.forward : p.backward
                : a == b.totalPages
                    ? 'ltr' == b.direction ? p.backward : p.forward
                    : p.all
            : 'ltr' == b.direction
        ...
        _foldingPage: function () {
          ...
          if (b.turn)
            return (a = b.turn.data ()), 'single' == a.display
              ? a.pageObjs[b.next] ? a.pageObjs[0] : null
              : a.pageObjs[b.next];
        },
        ...
        _fold: function (a) {
          ...
          switch (a.corner) {
            case 'r':
              ...
              break;
            case 'l':
              b.wrapper.css ({width: d}), this.css ({
                position: 'relative',
                left: c,
              }), b.fpage.css ({
                left: d,
        ...
        _moveFoldingPage: function (a) {
          ...
          if (a) {
            ...
            b.backParent &&
              (b.backParent.prepend (
                b.folding
              ), delete b.backParent, delete b.folding);
        },
        _showFoldedPage: function (a, b) {
          ...
          if (c) {
            if (b) {
              var l = this,
                c = e.point && e.point.corner == a.corner
                  ? e.point
              ...
              h._fold.call (this, a), d.effect &&
                !d.effect.turning &&
                this.animatef (!1);
            g ||
              ((e.visible = !0), h._moveFoldingPage.call (
                this,
                !0
              ), e.fpage.show ());
            return !0;
        ...
        _eventStart: function (a) {
          ...
          if (!b.disabled && !this.flip ('isTurning')) {
            ...
            if (b.corner && h._foldingPage.call (this, b.corner))
              return h._showFoldedPage.call (this, b.corner) &&
                this.trigger ('pressed', [b.point]), !1;
            b.corner = null;
          }
        },
              ...
              !this.data ().effect &&
                ...
                ((a = h._cornerActivated.call (this, a[0]))
                  ? ((b = h._c.call (
                      ...
                      a.corner,
                      b.opts.cornerSize / 2
                    )), (a.x = b.x), (a.y = b.y), h._showFoldedPage.call (
                      this,
                      a,
                      !0
                    ))
